...
const NOTAS = [
  { id: 'demo-termo', type: 'informe', title: 'Termodinámica', created: ago(6), tagText: 'fisica, estudio, informe', body: `## Leyes de la termodinámica
...
Entregar el informe final el 30 de octubre.` },
  { id: 'demo-maquinas', type: 'nota', title: 'Máquinas térmicas', created: ago(5), tagText: 'fisica, estudio', body: `## Ciclo de Carnot
...
Ejemplo: motor de un coche, nevera (al revés). Base teórica en [[Termodinámica]].` },
  { id: 'demo-cuantica', type: 'nota', title: 'Física cuántica', created: ago(4), tagText: 'fisica, estudio', body: `## Ideas clave
...
Relación con la energía en [[Termodinámica]].` },
  { id: 'demo-ensayo', type: 'tarea', title: 'Ensayo de historia: la Revolución francesa', created: ago(2), tagText: 'historia, tarea', body: `Entregar el ensayo el 15 de noviembre.
...
Apoyo en [[Revolución francesa]].` },
  { id: 'demo-revfr', type: 'nota', title: 'Revolución francesa', created: ago(2), tagText: 'historia, estudio', body: `## Cronología
...
export async function loadDemo() {
  for (const n of NOTAS) {
    await notes.save({ ...n, updated: n.created });
  }
  ...
  await requests.save({ id: 'demo-req1', skill: 'examinar', prompt: 'resume el tema: fotosíntesis', status: 'hecho', created: ago(1), reportId: 'demo-informe' });
  await requests.save({ id: 'demo-req2', skill: 'parte-del-dia', prompt: 'qué tengo hoy', status: 'pendiente', created: Date.now() });
